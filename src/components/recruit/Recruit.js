    ...
    <div className={styles.scrollcontainer}>
      <div className={styles.recruitcontent}>
        ...
        <div className={styles.rcontentsbox}>
          ...
          <textarea name="additionalComments" value={additionalWriting} spellCheck="false" ref={additionalWritingAreaRef} onChange={(e) => handleTextAreaChange(e, additionalWritingAreaRef, setAdditionalWriting, setAdditionalWritingCount, 100)} />
